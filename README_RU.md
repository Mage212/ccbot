...
4. Будет создано tmux-окно, запустится `claude`, и ваше отложенное сообщение отправится в сессию

**Отправка сообщений:**

После привязки topic к сессии отправляйте текст в topic — он уходит в Claude Code через tmux.
